...
internal class ConfigureOctoOpenApiOptions(IOptions<OctoPolicyOptions> octoPolicyOptions)
    : IConfigureNamedOptions<OctoOpenApiOptions>
{
    ...
    {
        options.AuthorityUrl = octoPolicyOptions.Value.AuthorityUrl.EnsureEndsWith("/");
    }
}