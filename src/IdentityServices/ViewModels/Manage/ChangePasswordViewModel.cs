...
{
    [Required(ErrorMessageResourceName = nameof(IdentityTexts.Backend_Identity_ChangePassword_Validation_CurrentPassword),
        ErrorMessageResourceType = typeof(IdentityTexts))]
    [DataType(DataType.Password)]
    [Display(Name = nameof(IdentityTexts.Backend_Identity_CurrentPassword_Label), ResourceType = typeof(IdentityTexts))]
    ...
    [Compare("NewPassword",
        ErrorMessageResourceName = nameof(IdentityTexts.Backend_Identity_ChangePassword_Validation_Match),
        ErrorMessageResourceType = typeof(IdentityTexts))]
